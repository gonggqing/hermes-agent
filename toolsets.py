...
TOOLSETS = {
    ...
    "finance": _ts(
        "Finance analysis (read-only): quotes, K-lines, symbol analysis, research, "
        "paper-account visibility, and human-confirmed portfolio drafts. Order "
        "placement and candidate approval are deliberately excluded.",
        [
