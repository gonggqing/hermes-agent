...
- [ ] Configure official `upstream` remote and complete a reviewed, tested Hermes `main` sync dry run before Phase 1; establish weekly weekend sync reports/integration branches
