...
# This fork intentionally seeds a Finance-oriented persona while preserving the
# Hermes product identity and upstream runtime behavior. Existing customized
# SOUL.md files are never overwritten.
...
_UPSTREAM_DEFAULT_SOUL_MD_2026_09 = (
