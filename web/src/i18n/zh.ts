  ...
  finance: {
    ...
    brief: {
      ...
      risk: {
        title: "风险",
        description:
          "展示账户资金、现金、回撤与风险敞口，用于判断当前组合的承压能力。",
        equity: "净值",
        cash: "现金",
        dayPnl: "当日盈亏",
        drawdown: "回撤",
      ...
      themes: {
        title: "主题",
        description:
          "按行业与产业链聚合标的表现，用于观察市场强弱是否正在形成共同方向。",
        symbols: "{n} 个标的",
        leaders: "领先",
        empty: "暂无主题数据。",
      },
      ...
      signals: {
        title: "今日信号",
        description:
          "汇总分析模型对标的方向、置信度与核心依据的判断，用于比较不同证据之间的一致性。",
        empty: "今日交易日尚无信号记录。",
        confidence: "置信度 {pct}%",
        asOfBar: "数据截至 {date}",
      },
      uncertainty: {
        title: "未知与不确定性",
        description:
          "列出数据、事件与研究证据中的缺口，用于识别当前结论最需要补充验证的部分。",
        empty: "暂无标记项。",
      },
      provenance: {
        title: "数据来源",
    ...
    portfolioControls: {
      title: "仓位管理",
      description: "这些上限由确定性风控执行，模型不能自行放宽。",
      ...
      subsetNote: "Agent 资金窗口包含在组合投资目标内，不与其相加。",
      currencyNote:
        "现金与订单按币种隔离；组合比例按实时汇率折算。系统不会未经确认自动换汇。",
      save: "保存设置",
      saving: "保存中…",
      saved: "仓位设置已生效。",
      loadError: "无法加载仓位设置。",
      saveError: "无法保存仓位设置：{error}",
    },
    prediction: {
      groupLabel: "研究复盘",
      navLabel: "预测复盘",
      title: "预测复盘",
      description:
        "持续记录研究系统当时如何判断、判断如何修订，以及每个交易日周期结束后的实际结果。",
      allMarkets: "全部市场",
      activeForecasts: "当前判断",
      evaluation: "预测评估",
      backtests: "策略回测",
      backtestEmpty:
        "Phase 0.98 的 Quant 滚动样本外回测将在这里展示，并与实时研究准确率和账户盈亏严格分开。",
      statActive: "活跃判断序列",
