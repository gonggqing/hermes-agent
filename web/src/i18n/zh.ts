...
export const zh: Translations = {
  ...
  finance: {
    page: {
      ...
      serviceOfflineBody: "仪表盘无法连接交易服务。请在本机启动该服务后刷新：",
    ...
    brief: {
      ...
      summary: {
        title: "研究员简报",
        subtitle: "用容易理解的方式说明今天的数据意味着什么、为什么值得关注，以及哪些地方仍需核实。",
        marketLabel: "市场判断",
        focusLabel: "当前主线",
        opportunityLabel: "值得继续研究",
        riskLabel: "风险与下一步",
        marketRiskOn: "风险偏好较好，但这不代表所有标的都适合买入。",
        marketNeutral: "市场信号分化，更适合精选标的，而不是笼统增加整体仓位。",
        marketRiskOff: "风险偏好偏弱，当前应优先保护本金，并提高入场要求。",
        marketUnknown: "当前市场数据不足，无法可靠判断市场环境。",
        marketFacts: "VIX 为 {vix}；观察范围中有 {breadth}% 位于 50 日均线上方。",
        themeFocus: "{theme} 是当前最强主题（相对 50 日均线 {distance}），领先标的包括 {leaders}。",
        moverFocus: "{symbol} 是当前最明显的异动标的（相对 20 日均线 {distance}）。",
        focusUnknown: "目前还没有足够完整的主题或异动快照。",
        opportunity: "{symbol} 以 {score} 分位列发现池第一。主要原因：{reasons}。",
        opportunityNone: "今天没有新标的同时通过证据、趋势和流动性检查。",
        riskClear: "本次快照没有额外的监控警告。",
        riskSummary: "当前有 {freshness} 项数据新鲜度警告、{risk} 项组合风险提示和 {unknown} 项研究缺口需要核实。",
        action: "发现评分只表示研究优先级，不代表预期收益或买入评级；下单前仍需核实证据、估值和组合风险。",
      },
      risk: {
        title: "风险",
        description: "回答组合是否承受得起新增风险。熔断、回撤、现金和警告应优先于任何看起来有吸引力的机会。",
        equity: "净值",
        cash: "现金",
        dayPnl: "当日盈亏",
        drawdown: "回撤",
      ...
      regime: {
        title: "市场状态",
        description: "综合波动率、市场广度和主要指数趋势，判断当前环境更偏进攻、中性还是防守。",
        vix: "VIX",
        breadth: "50日均线上方广度",
      ...
      movers: {
        title: "自选股异动",
        description: "按相对 20/50 日均线的异常偏离排序。偏离较大只表示需要关注，不等于便宜或值得追涨。",
        top: "居前",
        bottom: "居后",
        symbol: "代码",
        last: "最新价",
      ...
      themes: {
        title: "主题",
        description: "把相关标的合并观察，用来判断强弱是否具有行业或产业链共性，而不是单一个股的偶然波动。",
        symbols: "{n} 个标的",
        leaders: "领先",
        empty: "暂无主题数据。",
      },
      discovery: {
        title: "新机会发现池",
        description: "仅供继续研究的候选标的，已通过来源、代码、趋势和流动性检查，但尚未通过组合风控与人工确认。",
        empty: "今日暂无通过来源、代码、趋势和流动性验证的新标的。",
        score: "研究评分",
        scoreMeaning: "评分根据已保留的证据和筛选因子排列研究优先级，不是收益预测，也不是买入评级。",
        reasons: "评分依据",
        noReasons: "该标的没有保留下更细的评分原因。",
        reasonTrend: "20 日价格趋势 {value}",
        reasonRelativeStrength: "相对强度 {value}",
        reasonVolume: "成交量为 20 日均值的 {value}",
        sources: "证据来源",
      },
      synthesis: {
        title: "中港跨市场综合",
      ...
      news: {
        title: "新闻摘要",
        description: "突出最重要且有来源的新闻。情绪分数只帮助排序，调整判断前仍应阅读原始来源。",
        empty: "最新快照中没有新闻条目。",
        sentiment: "情绪",
      },
      signals: {
        title: "今日信号",
        description: "汇总各分析 Agent 的方向、置信度和核心论点。信号仍属于研究，必须经过风控与确认才可能执行。",
        empty: "今日交易日尚无信号记录。",
        confidence: "置信度 {pct}%",
        asOfBar: "数据截至 {date}",
      },
      uncertainty: {
        title: "未知与不确定性",
        description: "列出缺失、过期或尚未解决的证据；这些是决策约束，不是可以略过的脚注。",
        empty: "暂无标记项。",
      },
      provenance: {
        title: "数据来源",
    ...
    queue: {
      ...
      session: {
        title: "交易 Session",
        hint: "立即运行 监控 → 决策 → 推送，并开启新的审批窗口（也可用于补跑错过的 Session）。此操作不会下单；请先在下方批准候选订单，再结算。",
        run: "Run Session",
        running: "运行中…",
        finalize: "结算并下单",
    ...
    market: {
      ...
      persistedBrief: "研报快照",
      noSnapshot:
        "暂无可用市场快照——当前既无实时轮询，也无可恢复的持久化研报状态。",
    },
    reports: {
      title: "最新报告",
    ...
    watch: {
      ...
      customGroupReadOnly: "个人研究自选组 —— 只读，不会加入自动交易范围。",
      ...
      au9999Label: "AU9999 · 国内金价",
      au9999Note: "由国际金价 × 人民币汇率折算。",
      asOf: "截至 {time}",
      ...
      timeframeHint: {
        intraday: "5 分钟K线 · 约 1 天（左滑查看更多）",
        fiveDay: "30 分钟K线 · 约 5 天（左滑查看更多）",
        day: "日K线 · 约 6 个月（左滑查看更多）",
        week: "周K线 · 约 2 年（左滑查看更多）",
        month: "月K线 · 约 10 年（左滑查看更多）",
      },
      selectSymbol: "选择标的",
      priceScale: "价格坐标",
      indicators: {
        title: "指标",
        hint: "开关分析工具 —— 每条说明帮助你理解交易者如何解读。",
        overlay: "主图",
        pane: "副图",
        ma: "MA",
        maDesc: "移动平均线：平滑价格、显示趋势；价格在均线上方＝上升趋势。",
        ema: "EMA",
        emaDesc: "与 MA 类似，但更看重近期价格，反应更快。",
        boll: "BOLL",
        bollDesc: "布林带：均线 ± 2 倍标准差；贴近上轨＝偏高，贴近下轨＝偏低。",
        vol: "VOL",
        volDesc: "成交量：成交多少；放量时的大涨大跌更可信。",
        macd: "MACD",
        macdDesc: "趋势＋动能；MACD 上穿信号线为看涨。",
        rsi: "RSI",
        rsiDesc: "动能指标 0–100；高于 70 超买，低于 30 超卖。",
        kdj: "KDJ",
        kdjDesc: "随机动能；K 线上穿 D 线可能预示转涨。",
      },
      ma20: "MA20",
      ma30: "MA30",
      analyze: "分析",
    ...
    portfolio: {
      ...
      reviewGroup: "审核",
      loading: "正在加载投资组合…",
      loadError: "无法加载投资组合。金融服务可能已离线 —— 请刷新重试。",
      selectHint: "选择一个账户以查看其持仓，或添加一个账户。",
      noAccounts: "当前视图暂无账户。添加账户以开始跟踪持仓。",
      includeInRisk: "计入风险",
      environmentLive: "实盘",
      environmentPaper: "模拟盘",
      markets: { US: "美股", HK: "港股", CN: "A股" },
      providers: { manual: "手动", ibkr: "盈透 IBKR" },
      accountTypes: { cash: "现金账户", margin: "保证金账户" },
      securityTypes: { stock: "股票", etf: "ETF", fund: "基金" },
      eventTypes: {
        buy: "买入",
        sell: "卖出",
        dividend: "分红",
      ...
      form: {
        ...
        market: "市场",
        baseCurrency: "基础货币",
        baseCurrencyPlaceholder: "例如 USD",
        provider: "券商",
        accountType: "账户类型",
        environment: "实盘 / 模拟盘",
        environmentLive: "实盘账户",
        environmentPaper: "模拟账户",
        includeInRisk: "计入风险汇总",
        includeInRiskHint: "将该账户的持仓计入组合整体风险。",
        note: "备注",
        notePlaceholder: "可选备注",
        submit: "创建账户",
        submitting: "正在创建…",
        errName: "账户名称为必填项。",
        errCurrency: "基础货币为必填项。",
        created: "账户“{name}”已创建。",
        failed: "无法创建账户（{message}）。",
      },
      holdings: {
        title: "持仓",
        asOf: "数据截至 {time}",
      ...
      valuation: {
        ...
        totalPnl: "总盈亏",
        cash: "现金",
        pricedCount: "{priced} 已定价 · {unpriced} 未定价",
        refresh: "刷新实时价",
        refreshing: "正在刷新…",
        refreshDone: "{refreshed} 已刷新 · {skipped} 已跳过 · {failed} 失败",
        refreshFailed: "无法刷新实时价（{message}）。",
        updateMark: "更新现价",
        markPlaceholder: "新价格",
        markSave: "保存",
        markCancel: "取消",
        markSaved: "{symbol} 现价已更新。",
        markFailed: "无法更新现价（{message}）。",
        markErrPrice: "请输入正数价格。",
      },
      record: {
        title: "记录一笔交易或建仓",
        subtitle: "将创建草稿并作为人工录入予以确认。",
        instrument: "标的",
        instrumentPlaceholder: "搜索代码或名称…",
        searching: "正在搜索…",
        noMatches: "未找到匹配的标的。",
        degraded: "标的搜索已降级 —— 结果可能不完整。",
        selected: "已选择",
        clearInstrument: "清除标的",
        eventType: "事件类型",
        qty: "数量",
        price: "价格",
        priceHint: "若成本未知，请留空。",
        ...
        submit: "记录并确认",
        submitting: "正在记录…",
        errInstrument: "请先选择一个标的。",
        errQty: "数量必须为正数。",
        errPrice: "价格必须为正数，未知时请留空。",
        errCommission: "佣金必须为零或正数。",
        recorded: "{symbol} 已记录。",
        failedDraft: "无法创建草稿（{message}）。",
        failedConfirm: "草稿已创建但确认失败（{message}）。",
        requestFailed: "请求失败（{error}）。",
      },
      draftsView: {
        title: "待确认草稿",
        subtitle: "确认、编辑或拒绝录入 —— 包括 Hermes 从对话中生成的草稿。",
        empty: "暂无待审核草稿。",
        filterStatus: "状态",
        missing: "缺失：{fields}",
        ambiguities: "存疑：{items}",
        original: "来源：“{text}”",
        createdBy: "由 {actor} 创建",
        confirm: "确认",
        reject: "拒绝",
        edit: "编辑",
        save: "保存并确认",
        ...
        outcome: {
          ...
          rejected: "{symbol} 已拒绝",
          edited: "{symbol} 已更新",
          replayed: "{symbol}：已处理 —— 已回放先前结果",
          notHuman: "{symbol}：确认必须来自人工界面",
          incomplete: "{symbol}：草稿不完整（{message}）",
          invalidEdit: "{symbol}：编辑无效（{message}）",
          terminal: "{symbol}：草稿已终结",
          versionConflict: "{symbol}：草稿已在服务器端变更 —— 正在刷新",
          unknown: "{symbol}：未知草稿 —— 正在刷新",
          serviceUnavailable: "金融服务未激活（{message}）",
          unexpected: "{symbol}：{message}",
          unexpectedFallback: "意外响应（HTTP {status}）",
        },
      },
      import: {
        title: "导入 CSV",
        columns:
          "列：date、event_type、symbol、market、currency、qty、price、commission、amount、external_id、note。（date 与 event_type 为必填）",
        placeholder: "在此粘贴 CSV 行…",
        preview: "预览",
        previewing: "正在预览…",
        commit: "提交",
        committing: "正在提交…",
        emptyCsv: "先粘贴一些 CSV，然后进行预览。",
        headerError: "表头错误：{message}",
        summary: "{valid} 有效 · {invalid} 无效 · {duplicate} 重复",
        notCommittable: "提交前请先修正无效行。",
        colLine: "行",
        colStatus: "状态",
        colType: "类型",
        colSymbol: "代码",
        ...
        rowInvalid: "无效",
        committed:
          "已提交 {committed} 行（{duplicate} 重复，{skipped} 跳过）。",
      ...
      reconcile: {
        ...
        inSync: "一致",
        drift: "偏差",
        noDrift: "无偏差 —— 投资组合与券商一致。",
        driftSymbol: "代码",
        portfolioQty: "组合数量",
        brokerQty: "券商数量",
        unavailable: "该账户暂无对账数据。",
      },
      activity: {
        title: "活动",
        empty: "该账户暂无事件记录。",
      ...
      settings: {
        ...
        saving: "正在保存…",
        saved: "账户已更新。",
        failed: "无法更新账户（{message}）。",
        meta: "券商 {provider} · {market} · 基础货币 {currency}",
        created: "创建于 {time}",
      },
    },
  },
