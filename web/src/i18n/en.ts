...
export const financeEn: FinanceTranslations = {
  ...
  watch: {
    ...
    timeframeHint: {
      intraday: "5-minute candles · one session",
      fiveDay: "30-minute candles · ~5 days",
      day: "Daily candles · ~1 year",
      week: "Weekly candles · ~5 years",
      month: "Monthly candles · ~20 years",
    },
