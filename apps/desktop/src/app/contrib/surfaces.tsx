...
const FinanceView = lazy(async () => ({ default: (await import('../finance')).FinanceView }))
...
export const ChatRoutesSurface = memo(function ChatRoutesSurface({
  ...
  return (
    <Routes>
      ...
      <Route element={page(<FinanceView setStatusbarItemGroup={setStatusbarItemGroup} />)} path="finance" />
