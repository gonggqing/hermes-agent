...
describe('Finance route', () => {
  it('remains a reserved workspace page after upstream route refactors', () => {
    expect(appViewForPath(FINANCE_ROUTE)).toBe('finance')
    expect(routeSessionId(FINANCE_ROUTE)).toBeNull()
  })
})
