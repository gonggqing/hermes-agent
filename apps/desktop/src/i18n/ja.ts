...
export const ja = defineLocale({
  finance: {
    ...
    prediction: {
      ...
      navLabel: '予測レビュー',
      title: '予測レビュー',
      description: '当時の判断、その修正履歴、各取引期間後の実績を継続的に記録します。',
      allMarkets: '全市場',
      activeForecasts: '現在の予測',
      evaluation: '予測評価',
      backtests: '戦略バックテスト',
      backtestEmpty: 'Quant のウォークフォワード／アウト・オブ・サンプル結果は Phase 0.98 で表示します。',
      statActive: 'アクティブ系列',
      statEvaluated: '評価済みチェックポイント',
      statDue: '評価待ち',
      statAccuracy: '方向精度',
      sampleHint: '完了した方向チェックポイント',
      immature: 'サンプルが少ないため、現時点では記述的な参考値です。',
      mature: '最低サンプル数に達しましたが、信頼区間を考慮してください。',
      byMarket: '市場別',
      byHorizon: '期間別',
      recent: '最近の結果',
      empty: '表示できる予測記録はまだありません。',
      colMarket: '市場',
      colEntity: '対象',
      colDirection: '判断',
      colConfidence: '確信度',
    ...
    watch: {
      ...
      custom: {
        ...
        add: '銘柄を追加',
        searchPlaceholder: '上場株式またはETFを検索',
        heldSuggestions: '保有銘柄から追加',
        noMatches: '上場株式またはETFが見つかりません。コード、名称、市場サフィックスをお試しください。',
        rename: '名前を変更',
        delete: '削除',
        remove: 'リストから削除',
    ...
    portfolio: {
      ...
      controlsTitle: '配分管理',
      controlsDescription: 'これらの上限は決定論的なリスク管理で適用され、モデルは緩和できません。',
      investedTarget: '投資比率目標',
      investedTolerance: '投資比率の許容幅',
      agentBudget: 'Agent 資金枠',
      agentTolerance: 'Agent 許容幅',
      maxPosition: '単一銘柄上限',
      perTradeRisk: '取引ごとのリスク予算',
      maxNewPositions: '1日の新規ポジション上限',
      baseCurrency: '基準通貨',
      cashReserve: '最低現金比率',
      agentCeiling: 'Agent 配分上限',
      controlsNote: 'Agent 資金枠は投資比率目標に含まれ、追加配分ではありません。',
      currencyNote: '現金と注文は通貨別に管理し、比率は為替換算します。確認なしの自動両替は行いません。',
      saveControls: '設定を保存',
      savingControls: '保存中…',
      controlsSaved: '配分設定を更新しました。',
      controlsLoadError: '配分設定を読み込めませんでした。',
      controlsSaveError: '配分設定を保存できませんでした。'
    },
    holdings: {
      subnavAria: 'ポートフォリオ台帳',
      subnavPaper: 'ペーパー口座',
      subnavReal: 'マイ保有',
      paperAccountName: 'IBHK Paper（IBKR ペーパー口座）',
      environmentLive: 'ライブ',
      environmentPaper: 'ペーパー',
