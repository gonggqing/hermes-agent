...
export const zhHant = defineLocale({
  finance: {
    ...
    prediction: {
      ...
      navLabel: '預測覆盤',
      title: '預測覆盤',
      description: '持續記錄研究系統當時如何判斷、判斷如何修訂，以及每個交易週期結束後的實際結果。',
      allMarkets: '全部市場',
      activeForecasts: '目前判斷',
      evaluation: '預測評估',
      backtests: '策略回測',
      backtestEmpty: 'Phase 0.98 的 Quant 滾動樣本外回測將在此展示，並與研究準確率及帳戶盈虧分開。',
      statActive: '活躍判斷序列',
      statEvaluated: '已評估檢查點',
      statDue: '待補評估',
      statAccuracy: '方向準確率',
      sampleHint: '個已完成方向檢查點',
      immature: '樣本仍少，僅作描述，暫不比較模型優劣。',
      mature: '已達最低描述樣本量，仍需結合信賴區間。',
      byMarket: '按市場',
      byHorizon: '按週期',
      recent: '最近結果',
      empty: '目前還沒有可展示的預測記錄。',
    ...
    watch: {
      ...
      custom: {
        ...
        add: '新增標的',
        searchPlaceholder: '搜尋場內股票或 ETF',
        heldSuggestions: '從現有持倉加入',
        noMatches: '找不到相符的場內股票或 ETF，請嘗試代碼、名稱或市場後綴。',
        rename: '重新命名',
        delete: '刪除',
        remove: '從自選組移除',
    ...
    portfolio: {
      ...
      positionsEmpty: '暫無持倉。',
      controlsTitle: '倉位管理',
      controlsDescription: '這些上限由確定性風控執行，模型不能自行放寬。',
      investedTarget: '組合投資目標',
      investedTolerance: '組合浮動範圍',
      agentBudget: 'Agent 資金窗口',
      agentTolerance: 'Agent 浮動範圍',
      maxPosition: '單一標的上限',
      perTradeRisk: '單筆風險預算',
      maxNewPositions: '每日最多新建倉',
      baseCurrency: '統計基準幣種',
      cashReserve: '最低現金預留',
      agentCeiling: 'Agent 最高佔用',
      controlsNote: 'Agent 資金窗口包含在組合投資目標內，不與其相加。',
      currencyNote: '現金與訂單按幣種隔離；組合比例按匯率折算，系統不會未經確認自動換匯。',
      saveControls: '儲存設定',
      savingControls: '儲存中…',
      controlsSaved: '倉位設定已生效。',
      controlsLoadError: '無法載入倉位設定。',
      controlsSaveError: '無法儲存倉位設定。'
    },
    holdings: {
      subnavAria: '組合帳本',
      subnavPaper: '模擬帳戶',
      subnavReal: '我的持倉',
      paperAccountName: 'IBHK Paper（盈透模擬帳戶）',
      environmentLive: '實盤',
      environmentPaper: '模擬盤',
      groupPortfolio: '組合',
      groupAccounts: '帳戶',
      aggregate: '全部帳戶',
      drafts: '草稿',
