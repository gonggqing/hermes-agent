...
export const zh: Translations = {
  ...
  finance: {
    ...
    research: {
      ...
      riskTitle: '风险',
      riskDescription: '展示账户资金、现金、回撤与风险敞口，用于判断当前组合的承压能力。',
      riskEmpty: '暂无风险数据 — 风险监控和账本快照都尚不可用。',
      poolExposure: '资金池敞口',
      regimeDescription: '概括波动率、市场广度与主要指数趋势，用于理解当前市场风险偏好。',
      moversTitle: '研究范围异动',
      moversDescription: '比较本轮基础市场锚点与动态发现标的的趋势变化，用于识别跨行业的强弱切换。',
      ...
      themesTitle: '主题',
      themesDescription: '按行业与产业链聚合标的表现，用于观察市场强弱是否正在形成共同方向。',
      themesEmpty: '暂无主题数据。',
      discoveryTitle: '新机会发现池',
      discoveryDescription: '汇总系统新发现的标的，并结合证据完整度、趋势、流动性与主题相关性排列后续研究优先级。',
      discoveryEmpty: '本轮动态扫描已完成，但没有形成值得升级研究优先级的新标的。',
      discoverySourceUnavailable: '本轮没有取得全市场扫描输入；这表示发现源不可用，不代表市场没有机会。',
      ...
      signalsTitle: '今日信号',
      signalsDescription: '汇总分析模型对标的方向、置信度与核心依据的判断，用于比较不同证据之间的一致性。',
      ...
      uncertaintyDescription: '列出数据、事件与研究证据中的缺口，用于识别当前结论最需要补充验证的部分。',
      provenanceTitle: '来源',
      searchTitle: '研究检索',
    ...
    prediction: {
      ...
      navLabel: '预测复盘',
      title: '预测复盘',
      description: '持续记录研究系统当时如何判断、判断如何修订，以及每个交易日周期结束后的实际结果。',
      allMarkets: '全部市场',
      activeForecasts: '当前判断',
      evaluation: '预测评估',
      backtests: '策略回测',
      backtestEmpty: 'Phase 0.98 的 Quant 滚动样本外回测将在这里展示，并与实时研究准确率和账户盈亏严格分开。',
      statActive: '活跃判断序列',
      statEvaluated: '已评估检查点',
      statDue: '待补评估',
      statAccuracy: '方向准确率',
      sampleHint: '个已完成方向检查点',
      immature: '样本仍少，仅作描述，暂不比较模型优劣。',
      mature: '已达到最低描述样本量，解读时仍需结合置信区间。',
      byMarket: '按市场',
      byHorizon: '按周期',
      recent: '最近结果',
      empty: '目前还没有可展示的预测记录。',
    ...
    portfolio: {
      ...
      positionsEmpty: '暂无持仓。',
      controlsTitle: '仓位管理',
      controlsDescription: '这些上限由确定性风控执行，模型不能自行放宽。',
      investedTarget: '组合投资目标',
      investedTolerance: '组合浮动范围',
      agentBudget: 'Agent 资金窗口',
      agentTolerance: 'Agent 浮动范围',
      maxPosition: '单一标的上限',
      perTradeRisk: '单笔风险预算',
      maxNewPositions: '每日最多新建仓',
      baseCurrency: '统计基准币种',
      cashReserve: '最低现金预留',
      agentCeiling: 'Agent 最高占用',
      controlsNote: 'Agent 资金窗口包含在组合投资目标内，不与其相加。',
      currencyNote: '现金与订单按币种隔离；组合比例按汇率折算，系统不会未经确认自动换汇。',
      saveControls: '保存设置',
      savingControls: '保存中…',
      controlsSaved: '仓位设置已生效。',
      controlsLoadError: '无法加载仓位设置。',
      controlsSaveError: '无法保存仓位设置。'
    },
    holdings: {
      subnavAria: '组合账本',
      subnavPaper: '模拟账户',
